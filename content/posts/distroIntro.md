...
这句话写于 24 年 9 月 11 日：貌似 Fedora 41 默认就要移除 Xorg 的支持了，不过用户可以选择安装后下回来？GNOME 47 貌似也修复了 XWayland 分数缩放的问题，这个修复我没太看出来，不过 GNOME 47 的设置里的分数缩放终于默认就是可用的，再也不需要用 gsettings 开启了。
