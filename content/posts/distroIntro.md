...
>
> 我很久之前一直纠结于一个问题，那就是我似乎不能看到 Arch Linux 官方软件包的打包日志，并且根据我对它打包流程的理解，应该是把责任都推给了那些核心开发者身上，由开发者打包并使用 GPG 签名保证用户下载的时候不出现问题。这真的太信任那些开发者了，我更希望有一个大家都能监控的网站能清晰透明地看到构建过程。
>
